...
import com.mr.nanke.utils.weixin.CoreServiceUtil;
import com.mr.nanke.utils.weixin.MessageUtil;
import com.mr.nanke.utils.weixin.SignUtil;
		...
		try {
			...
			if (point != null) {
				try {
					...
					WechatAuth auth = WechatAuthService.queryWechatInfoByOpenId(openId);
					log.debug("auth:" + auth);
					if (auth == null) {
